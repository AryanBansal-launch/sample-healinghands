    ...
    <footer className="bg-gradient-to-br from-primary-900 to-primary-800 text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/tranquil_healing_and_yoga?utm_source=qr&igsh=MTRkNW94MGJhbm1ocQ=="
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/share/1AoBU5o8v3/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary-200 hover:text-white transition-colors"
                aria-label="Facebook"
              ...
              <a
                href="https://whatsapp.com/channel/0029VaIQVodA89MZc8xAxg1b"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary-200 hover:text-[#25D366] transition-colors"
        ...
        <div className="mt-8 pt-8 border-t border-primary-700 text-center text-primary-200 text-sm">
          <p>&copy; {new Date().getFullYear()} The Healing Hands by Preyanka M Jain. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
